...
# single-user source secrets NEVER ship (the dist is copyable/shared; the
# credential stays with the builder). The target device fills its own
# dourmouse/local_secrets.py (see INSTALL.md).
